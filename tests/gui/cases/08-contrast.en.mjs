/**
 * Sidebar control contrast — English (en) variant.
 * Guards against white-on-white / black-on-black regressions via WCAG ratio math.
 */
...
function themeOf(label) {
  return label === 'Dark' || label === '暗色' ? 'dark' : 'light'
}
...
export default {
  ...
  async run(ctx) {
    ...
    for (const theme of ['Light', 'Dark']) {
      ...
      await shot(`08-contrast-${themeOf(theme)}-en`)
