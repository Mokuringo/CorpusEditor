/**
 * Role color bands — English (en) variant.
 * This case asserts on CSS tokens and role classes only (no UI text), so it is
 * locale-independent by construction; only the screenshot name is suffixed.
 */
